  ...
  return (
    <SelectPrimitive.Root onValueChange={onValueChange} value={value}>
      <SelectPrimitive.Trigger asChild>
        <button
          className={cn(
            'focus-visible:border-brandDisabled hover:border-brandDisabled ease-ease data-placeholder:text-neutralPlaceholder flex w-full cursor-pointer items-center justify-between rounded-lg border py-2 pl-4 transition-colors duration-200',
            invalid ? 'border-negative' : 'border-grey200',
            className,
          )}
        >
