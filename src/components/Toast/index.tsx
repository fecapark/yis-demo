...
import { ToastLottieAssetMap, type ToastType } from '@/contexts/ToastProvider/type';
...
export const Toast = ({ children, type }: React.PropsWithChildren<{ type: ToastType }>) => {
  ...
  return (
    <div className="bg-grey100 flex w-fit items-center rounded-xl py-2 pr-5.5 pl-3 text-[15px] font-medium text-white">
